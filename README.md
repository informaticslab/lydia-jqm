STD Guidelines Second Generation Cross-Platform Mobile App (Lydia)
===========
STD Guidelines app will provide the 2014 STD Guidelines on iOS and Android smart phones. Developed using jQueryMobile and PhoneGap so future platforms may be coming.
